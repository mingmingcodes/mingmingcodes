...
| :--- | :--- | :--- |
| **Technical SEO / GEO** | Programmatic SEO (pSEO), JSON-LD Entity Graph, Semantic SEO, SGE Citing Optimization | Edge-Rendered SSG Framework, Python (BeautifulSoup/Scrapy), Google Search Console, Screaming Frog |
